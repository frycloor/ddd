...
from backend.services.gemini_client import generate_red_scenario_from_rule, generate_blue_patch_from_log
from backend.database import get_db
from backend.models import AIGeneratedScenario, Patch
from backend.schemas import ScenarioModel
