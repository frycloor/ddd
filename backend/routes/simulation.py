...
from backend.models import Rule, SimulationRun, EventLog, Patch
from backend.schemas import ScenarioModel, RunResultModel, RuleModel, PatchModel
from backend.utils.attack_scenarios import generate_relay_attack
from backend.utils.rule_engine import evaluate_scenario
import uuid
